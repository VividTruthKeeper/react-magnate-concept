        ...
        <div className="engineering-inner">
          ...
          <div className="engineering-content">
            <div className="indent-text">
              ...
              <p>
                Иногда без архитектурного проекта эксплуатация объекта
                невозможна. Поэтому исходно разрешительная документация,
                проведение геологических и геодезических изысканий позволит
                пройти бюрократические процедуры при вводе жилья в эксплуатацию,
                повысит инвестиционную привлекательность объекта в случае его
                продажи.
              </p>
            </div>
            <CustomList
            ...
            <div className="indent-text">
              <p>
                Мы проектируем частные жилые дома, загородные коттеджи или
                другие помещения по индивидуальному проекту под ключ. Чтобы
                реализовать свои идеи перед началом строительства и избежать
                непредвиденных расходов, закажите услугу на нашем сайте.
              </p>
            </div>
          </div>
        </div>
